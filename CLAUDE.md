...
- For hands-on practice notebooks: scaffold with the scenario/question in markdown cells and an empty/guided code cell — Varun writes the actual code himself, matching the `python-self-learning` convention. Fill in code only if Varun explicitly asks for it to be written.
